...
//     pdf.save(`battery_trace_${timestamp}.pdf`);
//   };

//   return (
//     <div className="table-container">
//       <h2>Battery Trace By Date</h2>
...
//       {loginSuccess && !loading && (batteryData.length > 0 || electrodeData.length > 0) && (
//       <div style={{display:"flex",justifyContent:"end"}}><button className="downlaod-report" onClick={handleDownloadPDF} style={{ marginBottom: "1rem" }}>
//     Download Report
//   </button></div>
//       )}
