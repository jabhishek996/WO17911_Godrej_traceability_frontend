...
const BatchSearch = () => {
  ...
  const handleSearch = async () => {
    ...
    const minLoading = new Promise((resolve) => setTimeout(resolve, 3000)); // minimum 2s loading
      ...
      {batchData && !loading && (
        <div>
          <h3 style={{ marginTop: '1rem', marginBottom: '1rem' }}>
            Batch ID: <span style={{ color: '#007bff' }}>{batchData.batch_id}</span>
          </h3>

          <div className="card-container">
            {renderCard('Batch Parameters', {
            ...
            {renderCard('Batch Production Time', {
              ...
              total_time:
                ...
                (new Date(batchData.stop_timestamp) - new Date(batchData.start_timestamp)) || "Null",
              batch_size: batchData.batch_size || "Null",
              total_electrodes_produce: batchData.total_electrodes_produce || "Null",
